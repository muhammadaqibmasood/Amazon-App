...
class MensFashion extends Component {
    constructor(props) {
        super(props);
        this.state = {
            array: [],
        ...
        return (<div>
          {this.props.select.length===0&&this.props.filters.text===''&&
            <div className='container bg-white'>
                    ...
                    <h1>Mens Fashion</h1>
                    <span> <Link to='/' class="fas fa-home fa-1x"></Link>  <i class="fas fa-angle-right fa-1x"></i> Mens Fashion</span>
...
export default connect(mapStateToProps)(MensFashion);