        ...
        return (<div>
          {this.props.select.length===0&&this.props.filters.text===''&&
            <div className='container bg-white'>
                    ...
                    <h1>Health Care</h1>
                    <span> <Link to='/' class="fas fa-home fa-1x"></Link>  <i class="fas fa-angle-right fa-1x"></i> Health Care</span>
                            ...
                            <div className="col-md-4 column">
                                <div class="card mycard">
                                    <Link className='myLink' to={`/information/${data._id}`}>
                                        <img class="card-img-top images" src={`${baseUrl}${data.image}`} alt="Not Found" />
                                        <p>{data.name}</p>
